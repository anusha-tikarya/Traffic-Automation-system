...
def test_validate_success(client, valid_token):
    ...
    # assert json_data["data"]["email_id"] == "valid@example.com"
...
# # Test for successful sign-in with valid credentials
# def test_signin_success(client):
#     """Test the /signin route with valid email and password."""
#     data = {
#         "email_id": "valid@example.com",
...
#     # Check if the response contains the token and user info
#     json_data = response.get_json()
#     assert json_data["message"] == "success"
#     assert "token" in json_data["credentials"]
#     assert json_data["credentials"]["email"] == "valid@example.com"
...
#     json_data = response.get_json()
#     assert json_data["msg"] == "Invalid token"  # Adjust the message based on your app's response
