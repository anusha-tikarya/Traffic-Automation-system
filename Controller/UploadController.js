const { S3Client, PutObjectCommand } = require('@aws-sdk/client-s3');// help connect aws
const { v4: uuidv4 } = require('uuid');//unique identifer
const multer = require('multer');// pass files , data n form from body
